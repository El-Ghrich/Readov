        ...
        <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            <div className="glass-dark p-8 md:p-12 rounded-2xl border border-white/5 space-y-8 animate-in fade-in duration-500">
                <div className="border-b border-white/10 pb-8">
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">About Readov</h1>
                </div>
                ...
                <div className="prose prose-invert max-w-none text-gray-300 space-y-6 leading-relaxed">
                    ...
                    <p>
                        And suddenly, it hit us: <strong className="text-white">Learning becomes magic when you let the learner be part of the story.</strong>
                    </p>
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        ...
                        <li>What if learning goals could fit naturally inside adventure and fantasy?</li>
                        <li>What if we could turn curiosity itself into the engine of education?</li>
                    </ul>
