    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-background">
        <div className="text-center space-y-4">
          ...
          <Link href="/stories" className="text-purple-600 hover:underline">
            Return to Library
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#f8f9fa] dark:bg-background pb-32">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-center gap-4 py-12 opacity-50">
            ...
            <span className="font-serif italic text-gray-500 dark:text-gray-400">
              {story.is_completed ? "The End" : "To be continued..."}
            </span>
            <div className="h-px bg-gray-300 dark:bg-gray-700 w-24"></div>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className="flex items-center justify-center w-12 h-12 bg-white/50 dark:bg-black/50 backdrop-blur-md border border-gray-200 dark:border-white/10 rounded-full text-gray-700 dark:text-gray-300 hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 hover:scale-110 transition-all shadow-lg"
          title="Scroll to Top"
        >
