                ...
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center">
                        <Link href="/" className="hover:opacity-80 transition-opacity">
                            <img src={theme === 'light' ? "/logo_purple.png" : "/img/logo_white.png"} alt="Readov" className="h-8" />
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center md:ml-6 space-x-4">
                        {user ? (
                            <div className="flex items-center gap-4">
                                ...
                                <Link href="/stories" className="text-muted-foreground hover:text-foreground text-sm font-medium mr-2">
                                    Dashboard
                                </Link>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Link href="/signup" className="bg-white text-black hover:bg-gray-200 px-4 py-2 rounded-full text-sm font-medium transition-all shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_25px_rgba(255,255,255,0.5)]">
                                    Sign Up
                                </Link>
                            </div>
                        )}
