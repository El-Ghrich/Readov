        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-1 space-y-4">
            ...
            <p className="text-sm text-[#a1a1b5] leading-relaxed">
              Turn your imagination into living stories. The platform where
          ...
          <div className="col-span-1 text-center md:text-left">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  href="/create"
                  className="text-[#a1a1b5] hover:text-[#4e45e3] transition-colors cursor-pointer"
                >
                  Start Creating
                </Link>
              </li>
          ...
          <div className="col-span-1 text-center md:text-left">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link
                  href="/contact"
                  className="text-muted-foreground hover:text-[#4e45e3] transition-colors cursor-pointer"
                >
                  Contact
                </Link>
              </li>
