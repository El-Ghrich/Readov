    ...
    return (
        <>
            ...
            <aside className={cn(
                ...
                {/* Logo Area & Toggle */}
                <div className={cn("mb-8 flex items-center transition-all duration-300 relative", isCollapsed ? "justify-center px-0" : "px-6 justify-between")}>
                    <Link href="/" className="hover:opacity-80 transition-opacity block overflow-hidden">
                        <div className={cn("transition-all duration-300 flex items-center justify-center", isCollapsed ? "w-10 h-10" : "w-auto")}>
                            <img
                                src={
                                    isCollapsed
                                        ? (theme === 'light' ? "/Favicon-purple.png" : "/Favicon-white.png")
                                        : (theme === 'light' ? "/logo_purple.png" : "/logo_white.png")
                                }
                                alt="Readov"
                                className={cn("object-contain transition-all", isCollapsed ? "h-8 w-8" : "h-8 md:h-9")}
                            />
                        </div>
                    </Link>
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            isCollapsed ? "-right-3 top-10 bg-white dark:bg-[#1a1a2e] border border-gray-200 dark:border-[#2d2d45] shadow-sm z-50" : "relative ml-auto"
                        )}
                ...
                <div className="flex-1 px-3 overflow-y-auto custom-scrollbar overflow-x-hidden">
                    ...
                    >
                        ...
                        {!isCollapsed && <span className="whitespace-nowrap">New Story</span>}
                    </Link>
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {!isCollapsed && <span className="whitespace-nowrap transition-opacity duration-200">{item.name}</span>}
                                </Link>
                            );
                        })}
                    </nav>
                        ...
                        >
                            {theme === 'dark' ? (
                                <>
                                    ...
                                    {!isCollapsed && <span className="font-medium whitespace-nowrap">Light Mode</span>}
                                </>
                            ) : (
                                <>
                                    <Moon className="w-5 h-5 text-[#4e45e3] flex-shrink-0" />
                                    {!isCollapsed && <span className="font-medium whitespace-nowrap">Dark Mode</span>}
                                </>
                            )}
                        </button>
                    </div>
                ...
                <div className="p-4 border-t border-gray-100 dark:border-[#2d2d45]" ref={profileMenuRef}>
                    {user ? (
                        ...
                        <div className="flex flex-col gap-2">
                            {isCollapsed ? (
                                <Link href="/login" className="flex items-center justify-center w-full h-10 rounded-lg bg-[#4e45e3] text-white hover:opacity-90" title="Log In">
