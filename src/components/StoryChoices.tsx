...
interface StoryChoicesProps {
  choices: string[];
  onSelect: (choice: string, type: "ai" | "custom", index?: number) => void;
  isLoading: boolean;
  showInput?: boolean;
  disabled?: boolean;
}
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-8 relative">
      ...
      <div className="flex justify-center mb-6">
        ...
        >
          <Sparkles
            className={`w-4 h-4 ${disabled ? "text-gray-400" : "text-yellow-300"}`}
          />
                    ...
                    >
                      <SpotlightCard
                        className={`
                                                ...
                                                `}
                        spotlightColor={
                          disabled ? "transparent" : theme.spotlight
                        }
                      >
                        <div className="mb-4 relative z-10">
                          <span
                            className={`text-xs font-mono uppercase tracking-widest px-2 py-1 rounded inline-block ${
                              disabled
                        ...
                        <p
                          className={`font-medium leading-relaxed relative z-10 transition-colors ${
                            disabled
